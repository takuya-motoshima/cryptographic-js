const Cipher = require('../dist/build.common.js').AES192CFB;
// const Cipher = require('cryptographic-js').AES192CFB;
...
console.log(`AES192CFB encryption/decryption result: ${plainText} -> ${encrypted} -> ${decrypted}`);
