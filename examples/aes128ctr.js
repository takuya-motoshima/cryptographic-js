const Cipher = require('../dist/build.common.js').AES128CTR;
// const Cipher = require('cryptographic-js').AES128CTR;
...
console.log(`AES128CTR encryption/decryption result: ${plainText} -> ${encrypted} -> ${decrypted}`);
