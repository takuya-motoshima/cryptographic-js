const Cipher = require('../dist/build.common.js').AES128CBC;
// const Cipher = require('cryptographic-js').AES128CBC;
...
console.log(`AES128CBC encryption/decryption result: ${plainText} -> ${encrypted} -> ${decrypted}`);
