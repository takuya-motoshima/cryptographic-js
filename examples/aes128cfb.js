const Cipher = require('../dist/build.common.js').AES128CFB;
// const Cipher = require('cryptographic-js').AES128CFB;
...
console.log(`AES128CFB encryption/decryption result: ${plainText} -> ${encrypted} -> ${decrypted}`);
